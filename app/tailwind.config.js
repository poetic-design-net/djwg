...
export default {
  ...
  "500": "#33cc99"
      ...
      fontFamily: {
        body: ["Clash Grotesk","ui-sans-serif","system-ui","-apple-system","BlinkMacSystemFont","Segoe UI","Roboto","Helvetica Neue","Arial","sans-serif"],
        heading: ["Clash Grotesk","ui-sans-serif","system-ui","-apple-system","BlinkMacSystemFont","Segoe UI","Roboto","Helvetica Neue","Arial","sans-serif"],
        sans: [
          'ui-sans-serif',
          'system-ui',
          '-apple-system',
