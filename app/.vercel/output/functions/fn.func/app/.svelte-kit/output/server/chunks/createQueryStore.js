...
const createQueryStore$1 = (options) => {
  ...
  return {
    ...
    setServerClient: (newClient) => {
      ...
      unstable__serverClient2.instance = client = cloneClientWithConfig(newClient), unstable__serverClient2.canPreviewDrafts = !!client.config().token, $fetcher.set(createDefaultFetcher());
    },
    unstable__cache,
