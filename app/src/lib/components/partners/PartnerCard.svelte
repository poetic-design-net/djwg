    ...
    <div class="flex gap-2 flex-wrap">
      {#if partner.website}
        <button 
          ...
          class="flex items-center gap-2 px-3 py-2 bg-blue-600/20 text-blue-400 rounded-md hover:bg-blue-600/30 transition-colors text-sm border border-blue-600/30 cursor-pointer"
