 ...
 <div class="relative rounded-3xl p-8 border border-gray-800/40 overflow-hidden">
    ...
    <div class="relative">
      ...
      <div class="flex flex-col sm:flex-row gap-4">
        <a 
          href="https://wa.me/+491728705171" 
          target="_blank" 
          rel="noopener noreferrer"
          class="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-gray-900 hover:bg-green-400 hover:text-black rounded-xl transition duration-300"
        >
        ...
        <a 
          href="mailto:webmaster@djworkshopgermany.de" 
          class="inline-flex items-center  px-6 py-3 text-sm font-medium text-white bg-gray-900 hover:bg-green-400 hover:text-black rounded-xl transition duration-300"
        >
