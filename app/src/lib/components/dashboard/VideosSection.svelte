  ...
  {:else}
    {#each sortedCategories as [categoryTitle, videos]}
      <div class="mb-12 last:mb-0">
        <div class="flex items-center gap-4 pb-4 border-b border-gray-800 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {#each videos as video}
            <div 
              class="relative rounded-lg overflow-hidden border border-gray-800/40 bg-gray-900 text-white group cursor-pointer transform transition-all duration-200 hover:scale-[1.02]"
...
{#if selectedVideo}
  <div class="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4" transition:fade={{duration: 150}}>
